...
```
hashcat (shooter_hashcat) starting in help mode
...
- [ Attack Modes ] -
 ...
 13 | Ordered component pipeline: wordlists + masks + rules
...
- [ Attack-Mode 13 Ordered Stages ] -

  Form          | Stage
 ===============+==================================================
  FILE          | wordlist (use wordlist:PATH to force)
  ?d?d / mask:  | inline mask
  .hcmask       | mask file (or maskfile:PATH)
  -r RULEFILE   | transform the complete prefix assembled to its left
...
- [ Basic Examples ] -
 ...
 ==================+=======+==================================================================
  ...
  Combinator       | MD5   | hashcat -a 1 -m 0 example0.hash words1.dict words2.dict [words3.dict ...]
  ...
  Ordered pipeline | MD5   | hashcat -a 13 -m 0 example0.hash example.dict -r rules/best66.rule ?d?d example.dict
